...
# Add parent dir to path to access config
...
class MLTrainerV3:
    ...
    def fetch_training_data(self, n_bars: int = 50000) -> pl.DataFrame:
        ...
        if rates is None or len(rates) == 0:
            raise ValueError("Failed to fetch M5 data from MT5. Check connection and symbol.")
    ...
    def fetch_h1_data(self, n_bars: int = 5000) -> pl.DataFrame:
        ...
        rates = mt5.copy_rates_from_pos(cfg.SYMBOL, mt5.TIMEFRAME_H1, 0, n_bars)
        if rates is None or len(rates) == 0:
    ...
    def engineer_features(
        ...
        # Add H1 features
        print("   H1 features...")
        df = self._join_h1_features(df, df_h1)
    ...
    def save_model(self, output_name: str = "xgboost_model_v3.pkl"):
        ...
        model_data = {
            ...
            'model_type': 'XGBOOST_BINARY',  # Binary classification
